...
T::T()
{
	...
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			temp = i * 4 + j;
			if (temp == 5 || temp == 6 || temp == 7 || temp == 10)
				SHAPEarr[i][j] = 6;
			else
				SHAPEarr[i][j] = 0;
		}
	...
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			temp = i * 4 + j;
			if (temp == 5 || temp == 6 || temp == 7 || temp == 10)				/*for 0 degree shape*/
				Degree0[i][j] = 6;
			else
				Degree0[i][j] = 0;
			if (temp == 6 || temp == 9 || temp == 10 || temp == 14)				/*for 90 degree shape*/
				Degree90[i][j] = 6;
			else
				Degree90[i][j] = 0;
			if (temp == 5 || temp == 8 || temp == 9 || temp == 10)				/*for 180 degree shape*/
				Degree180[i][j] = 6;
			else
				Degree180[i][j] = 0;
			if (temp == 1 || temp == 5 || temp == 6 || temp ==9)				/*for 270 degree shape*/
				Degree270[i][j] = 6;
			else
				Degree270[i][j] = 0;
		}
...
void T::defaultPosi(RenderWindow& window)
{
	PosiX = 0, PosiY = 3;
...
void T::draw(RenderWindow& window, int PosiX, int PosiY)
{
...
void T::moveLeft(RenderWindow& window)
{
...
void T::moveRight(RenderWindow& window)
{
	if (Compare(Degree90) && PosiX >= 16) {
		draw(window, 16, PosiY);
	}
...
void T::moveDown(RenderWindow& window)
{
	if (Compare(Degree90)) {
		if (PosiX >= 16) {
			NewTetrimone = true;
...
void T::rotate(RenderWindow& window)
{
	if (Compare(Degree90) && PosiX >= 16) {
		draw(window, 16, PosiY);
	}
