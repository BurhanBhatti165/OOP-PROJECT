...
L::L()
{
	...
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			temp = i * 4 + j;
			if (temp == 1 || temp == 5 || temp == 9 || temp == 10)
				SHAPEarr[i][j] = 3;
			else
				SHAPEarr[i][j] = 0;
		}
	...
	for (int i = 0; i < 4; i++) {
		for (int j = 0; j < 4; j++) {
			temp = i * 4 + j;
			if (temp == 1 || temp == 5 || temp == 9 || temp == 10)				/*for 0 degree shape*/
				Degree0[i][j] = 3;
			else
				Degree0[i][j] = 0;
			if (temp == 5 || temp == 6 || temp == 7 || temp == 9)				/*for 90 degree shape*/
				Degree90[i][j] = 3;
			else
				Degree90[i][j] = 0;
			if (temp == 5 || temp == 6 || temp == 10 || temp == 14)				/*for 180 degree shape*/
				Degree180[i][j] = 3;
			else
				Degree180[i][j] = 0;
			if (temp == 6|| temp == 8 || temp == 9 || temp == 10)				/*for 270 degree shape*/
				Degree270[i][j] = 3;
			else
				Degree270[i][j] = 0;
		}
...
void L::defaultPosi(RenderWindow& window)
{
	PosiX = 0, PosiY = 3;
...
void L::draw(RenderWindow& window, int PosiX, int PosiY)
{
...
void L::moveLeft(RenderWindow& window)
{
...
void L::moveRight(RenderWindow& window)
{
	if (Compare(Degree180) && PosiX >= 16) {
		draw(window, 16, PosiY);
	}
...
void L::moveDown(RenderWindow& window)
{
...
void L::rotate(RenderWindow& window)
{
	if (Compare(Degree180) && PosiX >= 16) {
		draw(window, 16, PosiY);
	}
